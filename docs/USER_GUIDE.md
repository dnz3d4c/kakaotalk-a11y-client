...
- 말풍선의 공감 이모지를 클릭할 수 있습니다 (일부만 지원)
- SAPI5 음성이 설치되어 있다면 스크린 리더 없이도 사용할 수 있습니다.
...
프로그램 시작 후 5초 뒤에 자동으로 새 버전을 확인합니다.

- 새 버전이 있으면 알림 대화상자가 표시됩니다
- "예"를 선택하면 변경사항을 확인할 수 있습니다
- 다운로드 중 취소할 수 있으며, 취소 시 임시파일이 자동 정리됩니다
- 다운로드 완료 후 프로그램이 자동으로 재시작됩니다

수동으로 확인하려면 트레이 메뉴에서 "업데이트 확인"을 선택합니다.
...
카카오톡 PC 버전을 자체 지원하는 스크린 리더(예: 센스리더)와 함께 사용하면 충돌할 수 있습니다.
...
- 화면 배율에 따라 이모지 탐지 정확도가 달라질 수 있습니다
...
NVDA에서 테스트되었습니다. Windows 기본 TTS(SAPI5)도 지원합니다.
