...
1. 릴리즈 페이지에서 최신 릴리즈를 다운로드합니다.
2. 압축을 풀고 `KakaotalkA11y.exe`를 실행합니다.
3. 프로그램 시작 음성이 출력되면 정상입니다.

프로그램은 백그라운드에서 실행되며, 시스템 트레이 아이콘으로 상태를 확인할 수 있습니다.

### 자동 업데이트

프로그램 시작 시 자동으로 새 버전을 확인합니다. 새 버전이 있으면 GUI에서 알림이 표시됩니다.
